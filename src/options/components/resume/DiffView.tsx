        ...
        <div className="diff-section">
          ...
          {viewMode === 'inline' ? (
            <div className="diff-content-inline">
              {/* Index key is acceptable here: diff segments are transient, have no stable ID, and never reorder */}
              {summaryDiff.map((d, i) => (
              ...
              {isExpanded && (
                <div className="diff-bullets">
                  {eb.bullets.map((newBullet, idx) => {
                    ...
                    // Index key: bullets are positionally mapped to originals and never reorder
                    return (
                      <div
                        key={idx}
                      ...
                      >
                        ...
                        <div className="diff-bullet-content">
                          {!hasChanges ? (
                            ...
                            <div className="diff-content-inline">
                              {/* Index key: diff segments are transient and never reorder */}
                              {bulletDiff.map((d, i) => (
                                <span key={i} className={`diff-word diff-word-${d.type}`}>
                                  {d.text}
                                </span>
